...
//  carpo_driver
//
//  Created by Tien Dat on 12/11/17.
...
//        self.layer.borderColor = UIColor(red: 90/255.0, green: 174.0/255.0, blue: 224.0/255.0, alpha: 1.0).cgColor
//        
        ...
        for segment in segments {
            ...
            if showSegmentLabels { // do text rendering
                ...
                //                textAttributes[NSFontAttributeName] = UIFont(name: "Myriad Pro Bold", size: 50)
